"""Created migartion for models

Revision ID: 2d17adf34056
Revises: 5b8520b67c91
Create Date: 2025-03-23 14:08:13.849426
...
revision: str = "2d17adf34056"
down_revision: Union[str, None] = "5b8520b67c91"
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.PrimaryKeyConstraint("id"),
        sa.UniqueConstraint("user_id"),
        sa.UniqueConstraint("user_id", name="uq_user_cart"),
    )
